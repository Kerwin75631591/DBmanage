...
<div style="position:relative;border: 1px solid #E2E3E5;width: 700px;height: 400px;
   ...
   <span id="id" style="font-size:30px;margin-right:20px"></span>
   <span id="bookName" style="font-size:30px;margin-right:20px"></span>
   <span id="bookAuthor" style="font-size:30px;margin-right:20px"></span>
   <span id="isbn" style="font-size:30px;margin-right:20px"></span>
   <span id="bookPrice" style="font-size:30px;margin-right:20px"></span>
   <span id="availible" style="font-size:30px;margin-right:20px"></span>
   <span id="bookNumber" style="font-size:30px;margin-right:20px"></span>
